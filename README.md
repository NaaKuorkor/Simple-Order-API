...
## Edge Case
The API handles submission of invalid quantities. It set the minimum for the quantity to be positive one an will automatically reject any integer below 1 during validation.
